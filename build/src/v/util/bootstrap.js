      ...
      new Promise((resolve) => {
        ...
        (options.target || document.head).append(
          options.rtl
            ? v.link({
                rel: "stylesheet",
                href: "/src/assets/bootstrap/bootstrap.rtl.min.css",
              })
            : v.link({
                rel: "stylesheet",
                href: "/src/assets/bootstrap/bootstrap.min.css",
              })
        );
        v.dom.loadScripts(
          ...
          () => {
            (options.target || document.head).append(
              v.link({
                rel: "stylesheet",
                href: "/src/assets/bootstrap/bootstrap-icons.min.css",
              }),
              v.script({
                src: "/src/assets/bootstrap/masonry.pkgd.min.js",
              })
            );
            [
              ...(options.target || document).querySelectorAll(
            ...
            [...(options.target || document).querySelectorAll(".collapse")].map(
              (el) => {
